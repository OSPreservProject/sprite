 ...
 * devKbdMap.c --
 *
 * 	Hardware-dependent definitions of mappings from keyboards to ASCII 
...
#ifndef lint
static char rcsid[] = "$Header$ DECWRL (Berkeley)";
#endif not lint
...
/*
 *  Pmax raw key code for the F13 key on the PMAX keyboard.
 *  This key is interpreted specially by DevKbdQueueAddInput().
 */

unsigned int devKbdSpecialKey = 0x73; 

/*
 * The raw key code for the break signal is the null character.
 */
unsigned int devKbdBreakKey = 0;

/*
 * PMAX keyboard to Ascii, unshifted. 
 */

unsigned short devKbdPmaxToUnshiftedAscii[] = {
...
/*
 * PMAX keyboard to Ascii, shifted.
 */

unsigned short devKbdPmaxToShiftedAscii[] = {
/*  0 */ KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,
/*  4 */ KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,
/*  8 */ KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,
/*  c */ KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,	KBD_NOKEY,
