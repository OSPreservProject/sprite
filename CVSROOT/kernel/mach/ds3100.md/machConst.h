...
#define	MACH_SWITCH_REGS_OFFSET		(MACH_TRAP_MULT_HI_OFFSET + 4 + 4)
...
#define	MACH_LAST_USER_STACK_PAGE	(VMMACH_USER_MAPPING_BASE_PAGE - 1)
#define	MACH_MAX_USER_STACK_ADDR	(VMMACH_USER_MAPPING_BASE_ADDR)
