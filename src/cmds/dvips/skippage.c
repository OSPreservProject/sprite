...
case 167: case 235:
   ...
   break ;
/* specials */
case 239: i = dvibyte() ; predospecial(i) ; break ;
case 240: i = twobytes() ; predospecial(i) ; break ;
case 241: i = threebytes() ; predospecial(i) ; break ;
case 242: i = signedquad() ; predospecial(i) ; break ;
/* font definition */
case 243:
   fontdef() ;
   break ;
