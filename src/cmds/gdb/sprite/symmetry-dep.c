...
int regno;
{
  ...
  if (-1 == regno)
    {
#ifdef sprite
       regs.userRegs.trapEAX = *(int *)&registers[REGISTER_BYTE(0)];
       regs.userRegs.trapEBX = *(int *)&registers[REGISTER_BYTE(5)];
       regs.userRegs.trapECX = *(int *)&registers[REGISTER_BYTE(2)];
       regs.userRegs.trapEDX = *(int *)&registers[REGISTER_BYTE(1)];
       regs.userRegs.trapESI = *(int *)&registers[REGISTER_BYTE(6)];
       regs.userRegs.trapEDI = *(int *)&registers[REGISTER_BYTE(7)];
       regs.userRegs.trapESP = *(Address *)&registers[REGISTER_BYTE(14)];
       regs.userRegs.trapEBP = *(Address *)&registers[REGISTER_BYTE(15)];
       regs.userRegs.trapEIP = *(Address *)&registers[REGISTER_BYTE(16)];
       regs.userRegs.trapFlags = *(int *)&registers[REGISTER_BYTE(17)];
#else
...
fetch_inferior_registers()
{
  ...
  struct pt_regset regs;
    ...
    ptrace(XPT_RREGS, inferior_pid, &regs, 0);
#ifdef sprite
     ptrace(PTRACE_GETREGS, inferior_pid, &regs, 0);
     *(int *)&registers[REGISTER_BYTE(0)] = regs.userRegs.trapEAX;
     *(int *)&registers[REGISTER_BYTE(5)] = regs.userRegs.trapEBX;
     *(int *)&registers[REGISTER_BYTE(2)] = regs.userRegs.trapECX;
     *(int *)&registers[REGISTER_BYTE(1)] = regs.userRegs.trapEDX;
     *(int *)&registers[REGISTER_BYTE(6)] = regs.userRegs.trapESI;
     *(int *)&registers[REGISTER_BYTE(7)] = regs.userRegs.trapEDI;
     *(Address *)&registers[REGISTER_BYTE(15)] = regs.userRegs.trapEBP;
     *(Address *)&registers[REGISTER_BYTE(14)] = regs.userRegs.trapESP;
     *(Address *)&registers[REGISTER_BYTE(16)] = regs.userRegs.trapEIP;
     *(int *)&registers[REGISTER_BYTE(17)] = regs.userRegs.trapFlags;
     bcopy(regs.userFPURegs.fpu_stack[0], &registers[REGISTER_BYTE(3)], 10);
     bcopy(regs.userFPURegs.fpu_stack[1], &registers[REGISTER_BYTE(4)], 10);
     bcopy(regs.userFPURegs.fpu_stack[2], &registers[REGISTER_BYTE(8)], 10);
     bcopy(regs.userFPURegs.fpu_stack[3], &registers[REGISTER_BYTE(9)], 10);
     bcopy(regs.userFPURegs.fpu_stack[4], &registers[REGISTER_BYTE(10)], 10);
     bcopy(regs.userFPURegs.fpu_stack[5], &registers[REGISTER_BYTE(11)], 10);
     bcopy(regs.userFPURegs.fpu_stack[6], &registers[REGISTER_BYTE(12)], 10);
     bcopy(regs.userFPURegs.fpu_stack[7], &registers[REGISTER_BYTE(13)], 10);
#else    
