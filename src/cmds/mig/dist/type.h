...
extern ipc_flags_t itCheckFlags(/* ipc_flags_t name, identifier_t name */);
extern dealloc_t itCheckDeallocate(/* ipc_type_t *it, ipc_flags_t flags,
				      dealloc_t dfault, identifier_t name */);
extern boolean_t itCheckIsLong(/* ipc_type_t *it, ipc_flags_t flags,
