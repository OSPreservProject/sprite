...
tail=''
tr='/sprite/cmds/tr'
mkdir='/sprite/cmds/mkdir'
sort='/sprite/cmds/sort'
uniq='/sprite/cmds/uniq'
grep='/sprite/cmds/grep'
trylist='
Mcc
bison
cpp
