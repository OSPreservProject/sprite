char rcsid[] = "$RCSfile: perl.c,v $$Revision: 1.3 $$Date: 91/11/14 12:52:07 $\nPatch level: ###\n";
/*
 ...
 *
 * $Log:	perl.c,v $
 * Revision 1.3  91/11/14  12:52:07  jhh
 * patchlevel 19
 * 
 ...
 *
 * Revision 1.2  91/07/16  17:03:10  jhh
 * we use some sort of non-standard sed
 * 
 * Revision 1.1  91/07/16  12:16:14  jhh
 * Initial revision
 * 
