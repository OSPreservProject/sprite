/* $RCSfile: doio.c,v $$Revision: 1.3 $$Date: 91/11/14 12:52:09 $
 *
 ...
 *
 * $Log:	doio.c,v $
 * Revision 1.3  91/11/14  12:52:09  jhh
 * patchlevel 19
 * 
 ...
 *
 * Revision 1.2  91/08/12  16:41:16  jhh
 * Sprite version of stat() returns a few extra fields
 * 
...
#ifdef sprite
	(void)astore(ary,++sp,
	  str_2mortal(str_nmake((double)statcache.st_serverID)));
	(void)astore(ary,++sp,
	  str_2mortal(str_nmake((double)statcache.st_version)));
	(void)astore(ary,++sp,
	  str_2mortal(str_nmake((double)statcache.st_userType)));
	(void)astore(ary,++sp,
	  str_2mortal(str_nmake((double)statcache.st_devServerID)));
#endif
