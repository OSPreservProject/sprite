...
#
# Extra files that need to be added to the distribution.
#
DISTFILES   +=   machcode.def make-cc1.com make-cccp.com make.com \
                 md move-if-change rtl.def stab.def utils.mk
