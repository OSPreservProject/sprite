...
/*extern char *EXFUN(index,(CONST char *, int c));*/
extern void  EXFUN(abort,(void));
extern int   EXFUN(close,(int));
extern int   EXFUN(fcntl,(int des, int cmd, int e));
/*extern int   EXFUN(fprintf,(FILE *stream,CONST char *format,...));*/
/*extern int   EXFUN(printf,(CONST char *format,...));*/
extern int   EXFUN(qsort,(void *data,int els, int siz, int func()));
extern void  EXFUN(exit,(int));
extern long  EXFUN(fseek,(FILE*, int, int));
extern int   EXFUN(fclose,(FILE*));
extern void  EXFUN(bcopy,(char*,char*,int));
extern int   EXFUN(bcmp,(char *, char *, int));
extern void  EXFUN(bzero,(char *, int));
/*extern void *EXFUN(memset,(char *, int, int));*/
extern int   EXFUN(puts,(CONST char*));
extern int   EXFUN(fputs,(CONST char*,FILE*));
