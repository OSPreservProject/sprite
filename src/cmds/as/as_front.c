...
#ifndef lint
static char rcsid[] = "$Header: /sprite/src/cmds/as/RCS/as_front.c,v 1.2 90/08/06 21:07:58 rab Exp Locker: rab $";
#endif /* not lint */
    ...
    char **argv;
{
    ...
    sprintf(path, "/sprite/lib/gcc/%s.md/as.%s", hostMachine, targetMachine);
    execv(path, argv);
