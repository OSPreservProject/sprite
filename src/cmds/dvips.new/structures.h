 ...
 *   for dvi files.  It is (C) Copyright 1986-91 by Tomas Rokicki.
...
#define BANNER "This is dvips 5.45 Copyright 1986-91 Radical Eye Software\n" 
#include <stdio.h>
#ifdef SYSV
#include <string.h>
#else
