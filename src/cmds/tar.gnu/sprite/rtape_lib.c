...
#ifndef lint
static char *RCSid = "$Header: /sprite/src/cmds/tar.gnu/sprite/RCS/rtape_lib.c,v 1.3 92/03/28 17:32:35 kupfer Exp $";
#endif

/*
 * $Log:	rtape_lib.c,v $
 * Revision 1.3  92/03/28  17:32:35  kupfer
 * Lint.
 * 
 * Revision 1.2  90/06/28  15:34:58  rab
 * Added support for long filenames and long symbolic linkes.
 * 
 * Revision 1.1  90/03/21  21:54:41  rab
 * Initial revision
 * 
