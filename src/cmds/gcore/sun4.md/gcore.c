    ...
    char	*pidString;	/* String name of pid - use only for message. */
{
    ...
    */
     ...
     */
    if (debug) {
      fprintf (stderr,"Opening core file and putting process in debug state...\n");
    }
     ...
     */
      ...
      */
     if (debug) {
       fprintf (stderr,"Writing empty core header...\n");
     }
     ...
     */
     {
       if (debug) {
	 fprintf (stderr,"Getting data segment...\n");
       }
     ...
     */
       if (debug) {
	 fprintf (stderr,"Getting stack segment...\n");
       }
     ...
     if (debug) {
       ...
       fprintf (stderr,"Rewriting header...\n");
     }
     if (fwrite((char *)&coreHeader,sizeof(coreHeader),1,coreFile) != 1) {
    ...
    if (debug) {
       fprintf (stderr,"Core file closed, go home.\n");
     }
     retVal = TRUE;
     /* 
