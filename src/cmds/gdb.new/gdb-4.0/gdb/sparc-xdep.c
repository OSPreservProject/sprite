...
#define gregs ((struct regs *)core_reg_sect)
    ...
    *(int *)&registers[REGISTER_BYTE (Y_REGNUM)] = gregs->r_y;
       ...
       won't work, but it's worth the try. */
    {
      ...
      /* Through the #endif are failed attempts to make gdb.new
	 compatble with sprite core files as of 28.9.91 */
/*      printf("Old stack pointer %d\n", sp)*/
#ifdef sprite
      /* Sprite core files start on a page boundary */
/*      sp = sp & ~(getpagesize() - 1);*/
/*      printf("***\nNew stack pointer %d\n\n***", sp);*/
#endif
