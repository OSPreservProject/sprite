 ...
 */
#ifndef lint
static char     *rcsid = "$Id: dir.c,v 1.5 92/05/18 18:08:14 kupfer Exp $ SPRITE (Berkeley)";
#endif lint
    ...
    Lst           path;	    /* the Lst of directories to search */
{
	...
	if (Hash_FindEntry (&p->files, (Address)cp) != (Hash_Entry *)NULL) {
	    ...
	    /*
	     * If the file is an absolute pathname and its directory
