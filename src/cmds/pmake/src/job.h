 ...
 *
 *	"$Id: job.h,v 1.3 90/09/19 13:01:24 douglis Exp $ SPRITE (Berkeley)"
 */
#ifndef _JOB_H_
#define _JOB_H_
...
extern void Job_RestartJobs();  /* Try to restart stopped jobs. */
...
extern void 	JobFlagForMigration(/* hostID */);/* Note that a host has
				       		 * been reclaimed. */
#endif /* _JOB_H_ */
