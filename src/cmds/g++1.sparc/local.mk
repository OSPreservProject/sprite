...
OBJS		+= $(TM).md/insn-emit.o $(TM).md/insn-extract.o \
		...
		$(TM).md/insn-recog.o $(TM).md/cplus-tab.o
CLEANOBJS	+= $(TM).md/insn-emit.o $(TM).md/insn-extract.o \
		...
		$(TM).md/genpeep $(TM).md/genrecog $(TM).md/cplus-tab.o
...
#
# Yacc can't handle cplus-parse.y
#
cplus-tab.c:	cplus-parse.yy
		bison -v -d -o cplus-tab.c $(.OODATE)
cplus-tab.h:	cplus-tab.c
$(TM).md/cplus-tab.o:	cplus-tab.c
		$(CC) $(CFLAGS) -o $(.TARGET) -c cplus-tab.c -DPARSE_OUTPUT=\"`pwd`/cplus-tab.output\"
