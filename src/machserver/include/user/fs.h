 ...
 *
 * $Header: /r3/kupfer/spriteserver/include/user/RCS/fs.h,v 1.3 91/12/12 22:23:07 kupfer Exp $ SPRITE (Berkeley)
 */
...
/* 
 * These constants are used to ensure that the MIG-generated size for a 
 * type agrees with its actual size.
 */
#define FS_ATTRIBUTES_SIZE	28	/* ints in an Fs_Attributes */
#define FS_DEVICE_SIZE		6	/* ints in an Fs_Device */
...
typedef struct Fs_Device {
    ...
    /* 
     * The rest of these fields are used only by the Sprite server.
     */
    mach_port_t	devPort;	/* handle returned by device_open */
    mach_port_t mmapPort;	/* memory object returned by device_map */
 ...
 */
typedef char Fs_PathName[FS_MAX_PATH_NAME_LENGTH];
