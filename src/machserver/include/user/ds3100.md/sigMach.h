 ...
 *     the signal module.  These are are for the MIPS hardware.
 *
 ...
 * software.
 *
 * $Header: /user5/kupfer/spriteserver/include/user/ds3100.md/RCS/sigMach.h,v 1.2 92/02/28 19:57:17 kupfer Exp $ SPRITE (Berkeley)
 */
