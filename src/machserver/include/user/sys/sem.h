...
/* $Header: /sprite/src/lib/include/sys/RCS/sem.h,v 1.2 91/09/09 22:13:33 kupfer Exp $ */
...
#define	GETKEYS	10	/* get all keys */
...
#ifdef KERNEL
	Sync_Condition semLock;	/* Lock for the semaphore. */
#endif
};
