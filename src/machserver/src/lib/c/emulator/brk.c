...
#ifndef lint
static char rcsid[] = "$Header: /user5/kupfer/spriteserver/src/lib/c/emulator/RCS/brk.c,v 1.4 92/03/12 19:22:32 kupfer Exp $ SPRITE (Berkeley)";
#endif /* not lint */
				 ...
				 * above top of heap".  */
{
	...
	kernStatus = Vm_CreateVAStub(SpriteEmu_ServerPort(),
				     (vm_address_t)realNextAddr,
				     (vm_size_t)(addr-realNextAddr), &status,
				     &sigPending);
