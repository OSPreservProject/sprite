...
#ifndef lint
static char rcsid[] =
"$Header: /user5/kupfer/spriteserver/src/cmds/login/RCS/login.c,v 1.2 92/04/02 21:53:55 kupfer Exp $ SPRITE (Berkeley)";
#endif /* lint */
...
#define DEBUG	1
#define FULLY_INSTALLED	0	/* 0 => don't use regular paths */
