...
#ifndef PR_NO_24BIT
/*
 * This gunk is for the cg8 and similar 24 bit + overlay frame buffers.
 * It shouldn't be in this file, but it's too late to take it out now.
 */
