...
#define GP2_LIGHT_AMBIENT       0x00
#define GP2_LIGHT_DIRECTIONAL   0x01
#define GP2_LIGHT_POSITIONAL	0x02

#define GP2_FRONT_PROPERTIES	0x00
#define GP2_BACK_PROPERTIES	0x01

#define GP2_BACK_FACE_REJ       0x00
#define GP2_BACK_FACE_SHADE     0x01
#define GP2_COPY_PNORM_TO_VNORM 0x02
#define GP2_GENERATE_PNORMAL    0x04
#define GP2_LIGHT_ON		0x08
#define GP2_LIGHT_OFF		0x10
#define GP2_IGNORE_FLAG         0x20

#define GP2_IGNORE_VERTEX_COLOR  0x02
#define GP2_IGNORE_VERTEX_NORMAL 0x01
#define GP2_IGNORE_VERTEX_DATA   0x03
#define GP2_IGNORE_LIGHTING      0x04
#define GP2_IGNORE_FRONT_FACE    0x21
#define GP2_IGNORE_BACK_FACE     0x22
#define GP2_IGNORE_ALL_FACES     0x23

/* For use with all XF_PGON commands.
 * Forces polygons to use the general polygon fill algorithm. This will slow
 * down some cases, but all polygons will use the same general algorithm that
 * handles all cases.  If 3D polygons are nearly planar, 
 * this should not be needed.
 */
#define GP2_GENERAL_POLYGON  0x80
...
#define pw_width(p) (p->pw_clipdata->pwcd_prmulti->pr_size.x)
#define pw_height(p) (p->pw_clipdata->pwcd_prmulti->pr_size.y)
#define pw_offset_X(p) (gp1_d(p->pw_clipdata->pwcd_prmulti)->cgpr_offset.x)
#define pw_offset_Y(p) (gp1_d(p->pw_clipdata->pwcd_prmulti)->cgpr_offset.y)
