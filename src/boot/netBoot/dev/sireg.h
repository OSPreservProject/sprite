 ...
 * addr_mod, int_vec, and bcrh. Thus, the sbc registers, fifo_data, 
 * bcr, and csr apply to both interfaces.
...
#define sbc_wreg sbc.write
	...
	u_short			iv_am;		/* address modifier and */
