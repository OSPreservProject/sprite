 ...
 */
struct	tmscp {
	char	tmscb_busx, tmscb_bus;	/* 8/16 bit bus flag */
 ...
 */
struct	tmscb {
	char	tmscb_03x, tmscb_03;	/* constant 0x03 */
 ...
 */
struct	tmccb {
	unsigned char tmccb_gate, tmccb_ccw;	/* interrupt control */
 ...
 */
struct	tmdevice {
	char	tmdev_reset;	/* Write resets */
	char	tmdev_attn;	/* Write wakes up ctlr */
};
