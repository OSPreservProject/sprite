...
#ifndef lint
static char rcsid[] = "$Header: /cdrom/src/kernel/Cvsroot/kernel/dev/sun4c.md/devSmem.c,v 1.1 92/08/13 15:54:01 secor Exp $ SPRITE (Berkeley)";
#endif not lint
