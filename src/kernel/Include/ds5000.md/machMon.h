 ...
 *
 * $Header: /sprite/src/kernel/Cvsroot/kernel/mach/ds5000.md/machMon.h,v 1.6 92/08/18 11:03:13 jhh Exp $ SPRITE (Berkeley)
 */
...
#define Mach_MonSetenv(name, value)	(mach_MonFuncs.setenv2)(name, value)
