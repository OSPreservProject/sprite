 ...
 *
 * $Header: /sprite/src/kernel/Cvsroot/kernel/mach/ds5000.md/machConst.h,v 1.6 91/08/09 15:23:36 shirriff Exp $ SPRITE (DECWRL)
 */
...
#define MACH_KERN_END		(VMMACH_VIRT_CACHED_START + \
				    (448 + 128 + 5) * 1024 * 1024)
