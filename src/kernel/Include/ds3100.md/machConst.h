 ...
 *
 * $Header: /sprite/src/kernel/Cvsroot/kernel/mach/ds3100.md/machConst.h,v 9.4 91/08/09 15:19:49 shirriff Exp $ SPRITE (DECWRL)
 */
...
#define	MACH_SWITCH_REGS_OFFSET		(MACH_TRAP_UNIX_RET_VAL_OFFSET + 16)
...
#define MACH_KERN_END		(VMMACH_VIRT_CACHED_START + 128 * 1024 * 1024)
