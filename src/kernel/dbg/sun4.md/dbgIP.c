...
#ifndef lint
static char rcsid[] = "$Header: /cdrom/src/kernel/Cvsroot/kernel/dbg/sun4.md/dbgIP.c,v 9.2 90/09/24 16:58:50 kupfer Exp $ SPRITE (Berkeley)";
#endif not lint
...
static char *	ProtNumToName _ARGS_((int num));
#endif
