...
%%
\def\@rm{ncs-rom} % the font used for \rm
\def\@it{ncs-ita} % the font used for \it
\def\@bf{ncs-bol} % the font used for \bf
\def\@sl{ncs-obl} % the font used for \sl
\def\@tt{c-con} % the font used for \tt
\def\@sf{h-red} % the font used for \sf
\def\@sc{ncs-romsc}%the font used for \sc
...
\def\PSfontversion{New Century Schoolbook}
