...
%%     abstract="This file contains the standard AMS names for
%%            symbols in the fonts MSAM* and MSBM*, using the
%%            \newsymbol macro of AMS-TeX. This file is required when
%%            \UseAMSsymbols is called in an AMS-TeX job. To use this
%%            file without AMS-TeX, the file AMSSYM.DEF (part of the
%%            AMSFonts distribution) should be input first.
%%            Instructions for using the AMS symbol fonts are
%%            included in: AMS-TeX 2.0 User's Guide; AMSFonts 2.0
%%            User's Guide; The Joy of TeX, editions dated 1990 or
%%            later."
%%     }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%     We save the current value of the @-sign catcode so that it can
...
%%     Set the catcode to 11 for use in private control sequence
%%     names.
\catcode`\@=11
