...
\def\makeindex{\if@filesw \newwrite\@indexfile
  ...
  \def\bfindex{\@bsphack\begingroup\@sanitize\@bfwrindex\@indexfile}
  \def\itindex{\@bsphack\begingroup\@sanitize\@itwrindex\@indexfile}
  \def\slindex{\@bsphack\begingroup\@sanitize\@slwrindex\@indexfile}
  \def\ulindex{\@bsphack\begingroup\@sanitize\@ulwrindex\@indexfile}
...
\def\@bfwrindex#1#2{\let\thepage\relax
   \xdef\gtempa{\write#1{\string
      \indexentry{#2}{{\string\bf \space\thepage}}}}\endgroup\gtempa
   \if@nobreak \ifvmode\@nobreak\fi\fi\@esphack}
\def\@itwrindex#1#2{\let\thepage\relax
   \xdef\gtempa{\write#1{\string
      \indexentry{#2}{{\string\sl \space\thepage\string\/}}}}\endgroup\gtempa
   \if@nobreak \ifvmode\@nobreak\fi\fi\@esphack}
\def\@slwrindex#1#2{\let\thepage\relax
   \xdef\gtempa{\write#1{\string
      \indexentry{#2}{{\string\sl \space\thepage\string\/}}}}\endgroup\gtempa
   \if@nobreak \ifvmode\@nobreak\fi\fi\@esphack}
\def\@ulwrindex#1#2{\let\thepage\relax
   \xdef\gtempa{\write#1{\string
      \indexentry{#2}{\string\ul{\thepage}}}}\endgroup\gtempa
   \if@nobreak \ifvmode\@nobreak\fi\fi\@esphack}

\def\ul#1{$\underline{\rm #1}$}
\def\index{\@bsphack\begingroup\@sanitize\@index}
\def\bfindex{\@bsphack\begingroup\@sanitize\@index}
\def\itindex{\@bsphack\begingroup\@sanitize\@index}
\def\slindex{\@bsphack\begingroup\@sanitize\@index}
\def\ulindex{\@bsphack\begingroup\@sanitize\@index}
